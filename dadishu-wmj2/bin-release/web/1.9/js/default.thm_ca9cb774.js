                ...
                generateEUI.skins = undefined;generateEUI.paths['resource/eui_skins/skin/gameOver.exml'] = window.NewFile = (function (_super) {
	...
	function SceneBegin() {
		_super.call(this);
		this.skinParts = ["bgc","time_label","score_label","group_1","group_2","group_3","group_4","group_5","group_6","group_7","group_8","group_9","e_group"];
		
		this.height = 580;
		this.width = 960;
		this.elementsContent = [this.bgc_i(),this.time_label_i(),this.score_label_i(),this.e_group_i()];
	}
	var _proto = SceneBegin.prototype;

	_proto.bgc_i = function () {
		var t = new eui.Image();
		this.bgc = t;
		t.height = 580;
		t.scaleX = 1;
